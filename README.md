...
<p><br><em>These props are unique to the FluidGrid container.</em></p>
...
<details>
    <summary><b>Item-Defaults Props</b> (expand)</summary>

<p><br><em>Some default props for grid-items can be set on the grid-container 
