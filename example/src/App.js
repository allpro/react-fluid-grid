	...
	return (
		<MuiThemeProvider theme={darkTheme}>
			...
			<List>
				<ListNavItem
					label="Readme"
					to="https://github.com/allpro/react-fluid-grid/blob/master/README.md"
					external
				/>
				<ListNavItem
					label="CodeSandbox Demo"
					to="https://codesandbox.io/s/github/allpro/react-fluid-grid/tree/master/example"
					external
				/>
			</List>
		</MuiThemeProvider>
...
class FluidGridDemo extends React.Component {
	constructor(props) {
		super(props)
...
FluidGridDemo.propTypes = {
	classes: object.isRequired
}

export default withStyles(styles)(FluidGridDemo)
